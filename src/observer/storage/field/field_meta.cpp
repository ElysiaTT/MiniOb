...
FieldMeta::FieldMeta()
    : attr_type_(AttrType::UNDEFINED), attr_offset_(-1), attr_len_(0), visible_(false), nullable_(false), field_id_(0)
{}
...
RC FieldMeta::from_json(const Json::Value &json_value, FieldMeta &field)
{
  ...
  bool        nullable = nullable_value.isBool() && nullable_value.asBool();
