...
{
public:
  IndexScanPhysicalOperator(Table *table, Index *index, ReadWriteMode mode, vector<char> left_key,
      bool left_inclusive, vector<char> right_key, bool right_inclusive);
...
private:
  ...
  vector<char> left_key_;
  vector<char> right_key_;
